...
* OpenShift クラスターのラボのコンソールにアクセスするには次のリンクを使用してください:https://console-openshift-console.%SUBDOMAIN%/topology/ns/globex-apim-%USERID%?view=graph[console^,role=external,window=openshiftconsole].
